...
/**
 * Servlet implementation class QuestionAttemptsTA
 */
@WebServlet("/QuestionAttemptsTA")
public class QuestionAttemptsTA extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionAttemptsTA() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session.getAttribute("ta_id") == null) { //not logged in
